---
title: "Effektstärken und ihre Grenzen"
subtitle: "Einheit 3 · Tag 1, Die Diagnose"
...
::: {.bp-warn}
Die Richtwerte von Cohen (0.2 · 0.5 · 0.8) sind grobe Orientierungen, keine
inhaltlichen Kriterien. Ein d = 0.3 kann in einem Kontext wichtig und in einem
anderen trivial sein.
:::

::: {.bp-zwei}
::: {}
**Groß:** d = 0.2 für eine Maßnahme, die flächendeckend und fast kostenlos
ausgerollt werden kann.
:::
::: {}
**Mittelmäßig:** d = 0.5 für ein aufwendiges Einzelförderformat in einem
gut beforschten Feld.
:::
:::
...
gezogen**. Das ist kein Schätzfehler, das ist systematisch.

$$d_{\text{beobachtet}} = d_{\text{wahr}} \cdot \sqrt{\text{Rel}}$$

| Reliabilität des Tests | aus wahrem d = 0.50 wird |
|---|---|
| 1.00 | 0.50 |
| .90 | 0.47 |
| .80 | 0.45 |
...
::: {.bp-warn}
Der beobachtete Effekt aus Einheit 1, **d = 0.42**, ist bei einer
Testreliabilität von .70 genau das, was ein wahrer Effekt von **0.50**
hinterlässt. Kein Stichprobenumfang der Welt holt das zurück.
:::
