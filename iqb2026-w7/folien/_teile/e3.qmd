...
::: notes
**Faden.** Davor: die Gruppen haben im Garten selbst nach einem signifikanten
Pfad gesucht, dann Pause. Hier: die Pfadzahlen zusammentragen und den
Wettbewerb auflösen. Überleitung: "Bis jetzt ging es darum, ob überhaupt etwas
da ist. Jetzt geht es darum, wie viel, und ob wir das überhaupt messen
können."
...
::: notes
**Faden.** Davor: zwei Einheiten darüber, ob überhaupt ein Effekt da ist.
Hier: der Wechsel zur Frage, wie groß er ist. Überleitung: "Und wieder fange
ich mit einer Frage an."
...
::: notes
**Faden.** Davor: der Titel kündigt Effektstärken und ihre Grenzen an. Hier:
eine Falle, die genau diese Grenzen vorführt, plus die Zahl der Hände auf der
Tafel. Überleitung: "Ich löse das am Ende der Einheit auf. Vorher drei Dinge
über Effekte."
...
::: notes
**Faden.** Davor: die offene Frage, ob d = 0.42 groß ist. Hier: der erste
Grund, warum sie so nicht beantwortbar ist, es fehlt die Einheit. Überleitung:
"Wenn die Einheit so wichtig ist, warum standardisieren wir dann überhaupt?"
...
**SD = 20** verschwinden im Rauschen. d ist ein
...
Preis: Punkte kann man einer Kommission erklären, d nicht.
:::

::: notes
**Faden.** Davor: berichte zuerst unstandardisiert. Hier: die faire
Gegenrechnung, was d tatsächlich leistet und warum es existiert. Überleitung:
"So weit das Lob. Jetzt die drei Gründe, warum d allein nicht reicht, und der
erste betrifft die Faustregeln."

Zuerst die Formel entschärfen: das ist eine Division, mehr nicht. Das laut zu
sagen entspannt spürbar.

Die Entdeckbarkeit erklärt, warum d sinkt, wenn die Streuung steigt, obwohl
sich am Effekt nichts ändert. Das ist genau der Mechanismus von den zwei
Standorten aus Einheit 1, jetzt in einer Kennzahl.

Die Vergleichbarkeit ist für dieses Publikum der relevantere Punkt. Zwei
Instrumente für dieselbe Kompetenz mit verschiedener Skalierung sind ohne
Standardisierung nicht vergleichbar. Das ist Alltag in der Bildungsforschung.
...
::: notes
**Faden.** Davor: d leistet Entdeckbarkeit und Vergleichbarkeit. Hier: der
erste Grund gegen d allein, die Richtwerte sind keine Kriterien und für
Bildungsinterventionen sogar falsch geeicht. Überleitung: "Wenn nicht die
Faustregel, woran hängt eine Effektstärke dann?"
...
Die Abbildung zeigt beides nebeneinander: oben die Bänder von Kraft für
Bildungsinterventionen, unten die Punktkonventionen von Cohen. Dieselbe Zahl
landet in zwei völlig verschiedenen Kategorien. Unser d = 0.42 ist bei Cohen
knapp unter mittel und bei Kraft weit im großen Bereich.
...
::: notes
**Faden.** Davor: die Faustregeln taugen nicht als Maßstab. Hier: der zweite
Grund, die Zahl selbst hängt am Design und nicht nur an der Wirkung.
Überleitung: "Und dann kommt noch eine dritte Fehlerquelle dazu, die fast
niemand berichtet."
...
::: notes
**Faden.** Davor: die Effektstärke hängt am Design. Hier: der dritte Grund,
sie hängt zusätzlich an der Genauigkeit des Instruments, und zwar immer in
dieselbe Richtung. Überleitung: "So viel zu den Grenzen. Zum Schluss ein Maß,
...
Publikum ist das der praktisch wertvollste Satz des Tages. Und es ist die
zweite Antwort auf die Teststärke-Folie von heute Nachmittag: dort war mehr n
die Lösung, hier ist es das bessere Instrument.
...
::: notes
**Faden.** Davor: drei Gründe, warum eine Effektstärke allein wenig sagt.
Hier: trotzdem ein Maß, das sofort verständlich ist, und die Einlösung des
Versprechens von der Einzelfall-Übersetzung. Überleitung: "Damit habt ihr alle
Bausteine für einen Ergebnissatz, der hält."

Die Tabelle mit allen Maßen ist bewusst von der Folie verschwunden und steht
jetzt aufklappbar auf dem Arbeitsblatt. Hier stattdessen fragen, welche Maße
die Anwesenden tatsächlich berichten, und nur die besprechen.
...
::: {.bp-warn}
**Was das Intervall leistet, und was nicht.** Es zeigt genau das, was
...
::: notes
**Faden.** Davor: CLES als verständliches Maß. Hier: alle fünf Pflichtangaben
auf einmal und die Auflösung der Eingangsfrage. Überleitung: "Und damit
bekommt jede Gruppe gleich ihr eigenes Messinstrument."

Die praktisch nützlichste Folie des ganzen Tages. Hier darf man langsam werden.

Die Reliabilitätsangabe ist die, die ich gegenüber dem üblichen Standard
ergänzt habe, und sie folgt direkt aus der Minderungsfolie. Ohne sie ist eine
Effektstärke nicht interpretierbar.

Der Vergleich mit dem Feld fehlt am häufigsten und macht am wenigsten Arbeit.
...
welche Auskunft denn fehlt, bekommt: genau die, die heute Nachmittag als
siebte Fehlannahme stand, nämlich dass der wahre Wert mit 95 Prozent
Wahrscheinlichkeit im Intervall liegt. Das kommt morgen. Derselbe Cliffhanger
wie in Einheit 1, hier nur nachgezogen, nicht aufgelöst.
...
::: notes
**Faden.** Davor: der Berichtsstandard mit fünf Angaben. Hier: der Auftrag,
jede Gruppe mit einer anderen Reliabilität. Danach: direkt der Tagesabschluss,
in dem sich aus den fünf Antworten die Minderungskurve zusammensetzt.
