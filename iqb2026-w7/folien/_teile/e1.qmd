...
::: {.bp-belege}
- **Lortie-Forgues & Inglis (2019),** Educational Researcher 48(3).
  **141 große Wirksamkeitsstudien** aus den Förderprogrammen von EEF und
  NCEE, zusammen über **1,2 Millionen Lernende**. Durchschnittlicher Effekt
  **0,06 SD**, durchschnittliche Intervallbreite **0,30 SD**. Der mittlere
  Bayes-Faktor liegt bei **0,56**, die Studien sind also überwiegend
  uninformativ.
- **Wasserstein & Lazar (2016),** The American Statistician 70(2). Die
  **erste Stellungnahme der American Statistical Association zu einer
  statistischen Frage überhaupt**. Kernsatz: Schlussfolgerungen sollen nicht
  daran hängen, ob ein p-Wert eine Schwelle überschreitet.
:::
...
Die Zahlen langsam nennen. Durchschnittlicher Effekt 0,06 Standardabweichungen
bei einer durchschnittlichen Intervallbreite von 0,30. Das heißt: das Intervall
ist fünfmal so breit wie der Effekt, den es einschließen soll. Viele dieser
Intervalle enthalten gleichzeitig nennenswerten Nutzen und nennenswerten
Schaden.

Der mittlere Bayes-Faktor von 0,56 ist der Hammer, und er kommt an Tag 2 wieder.
Ein Bayes-Faktor um 1 heißt: die Daten unterscheiden nicht zwischen Wirkung und
keiner Wirkung. Bei der Hälfte dieser Studien war der Aufwand also groß und der
Erkenntnisgewinn nahe null. Das hier schon ankündigen, in Einheit 6 einlösen.
...
::: {.bp-warn}
Signifikanz testet vor allem die **Stichprobengröße**. Und umgekehrt: bei
kleinem n bleibt ein großer Effekt unentdeckt.
:::
