...
::: notes
**Faden.** Davor: die Gruppen haben den Prior gegen die Daten antreten
lassen, dann Pause. Hier: zusammentragen, ab wann der Prior gewinnt.
...
::: notes
**Faden.** Davor: die Fragerunde endet mit der Frage, was man mit einer
Posterior anfängt. Hier: der Titel gibt die Antwort, es geht um Berichten und
Entscheiden. Überleitung: "Und ich fange, wie immer, mit einer Frage an."
...
::: notes
**Faden.** Davor: der Titel kündigt das Berichten von Evidenz an. Hier: der
Satz, den die Gruppe nach anderthalb Tagen nicht mehr unterschreibt, und die
Lücke, die er hinterlässt. Überleitung: "Genau diese Lücke schließen wir
jetzt, und zwar mit einem Bild."
...
::: notes
**Faden.** Davor: "kein Effekt gefunden" ist korrekt, aber leer. Hier: das
Werkzeug, das die Lücke schließt, drei mögliche Ausgänge statt zwei.
Überleitung: "Das ist die Entscheidung. Jetzt noch die Evidenz dahinter, und
die geht in beide Richtungen."
...
::: notes
**Faden.** Davor: HDI und ROPE liefern drei Ausgänge statt zwei. Hier:
dieselbe Symmetrie als Evidenzmaß, jetzt auch zugunsten der Nullhypothese.
Überleitung: "Eine Verwechslung fehlt noch, und die ist im Alltag ständig
relevant."
...
::: notes
**Faden.** Davor: der Bayes-Faktor als graduelle Evidenz. Hier: die letzte
Unterscheidung des Workshops, Aussage über den Mittelwert gegen Aussage über
den Einzelfall. Überleitung: "Damit habt ihr alles beisammen. Bleibt die
Frage, womit man das eigentlich rechnet."
...
::: notes
**Faden.** Davor: die beiden Unsicherheiten, epistemisch und aleatorisch.
Hier: womit man das alles tatsächlich rechnet, sortiert nach Vorkenntnis.
Überleitung: "Und jetzt setzt ihr die Entscheidung ein letztes Mal selbst
zusammen."
...
::: notes
**Faden.** Davor: die Werkzeuge für danach. Hier: Brücke zur letzten
Live-Demo, die ROPE wird selbst gesetzt. Überleitung: "Und dann seid ihr zum
letzten Mal dran."
...
::: notes
**Faden.** Davor: die Live-Demo an der ROPE. Hier: der letzte Auftrag, ein
Ergebnissatz für eine Kommission. Danach: direkt der Abschluss, in dem genau
diese Sätze vorgelesen werden.
