...
::: notes
**Faden.** Davor: Gruppenarbeit an den zwei Standorten, dann Pause. Hier: die
fünf Gruppen tragen zusammen, woran der Unterschied lag. Überleitung: "Bis
hierhin war der p-Wert das Problem. Jetzt schauen wir uns an, was passiert,
bevor er überhaupt berechnet wird."
...
::: notes
**Faden.** Davor: die Fragerunde hat den p-Wert als Kennzahl abgeschlossen.
Hier: der Titel verschiebt den Blick auf alles, was vor der Kennzahl passiert.
Überleitung: "Und ich fange wieder mit einer Frage an, diesmal einer
unangenehmen."

Kurz. Der Titel ist Programm.
:::
...
::: notes
**Faden.** Davor: der Titel kündigt an, dass es um die Entscheidungen vor der
Kennzahl geht. Hier: fünf solcher Entscheidungen, und alle im Raum kennen sie.
Überleitung: "Keine dieser fünf Handlungen ist Betrug. Das Problem entsteht
erst durch ihre Menge, und die will ich euch zeigen."
...
::: notes
**Faden.** Davor: fünf einzelne Entscheidungen, jede für sich harmlos. Hier:
dieselben Entscheidungen kombiniert, 24 Pfade auf einen Blick, wahrer Effekt
null. Überleitung: "Ist das ein konstruiertes Extrembeispiel? Leider nicht."
...
::: notes
**Faden.** Davor: der Garten zeigt 24 Pfade an unserem erfundenen Datensatz.
Hier: drei Zahlen, die belegen, dass das kein Einzelfall und längst benannt
ist. Überleitung: "So weit die Mechanik. Jetzt schauen wir, was davon am Ende
in der Literatur landet."
...
Genau die Kombination, die der Garten eben gezeigt hat.
...
::: notes
**Faden.** Davor: 61 Prozent Falsch-positiv-Rate, eine willkürliche Schwelle,
ein Journal das aussteigt. Hier: was daraus in der veröffentlichten Literatur
geworden ist, drei Befunde. Überleitung: "Bis hierhin ging es um
Entscheidungen beim Auswerten. Jetzt um die Fälle, die gar nicht erst in den
Daten landen."
...
systematisch überschätzt, und genau das hat die Teststärke-Folie aus Einheit 1
vorhergesagt. Diesen Bogen ausdrücklich schlagen.
...
::: notes
**Faden.** Davor: die Literatur überschätzt systematisch. Hier: eine zweite
Quelle derselben Verzerrung, diesmal schon in der eigenen Stichprobe.
Überleitung: "Dafür gibt es eine Systematik, und sie entscheidet, ob man es
reparieren kann."

Kernbotschaft: fehlende Daten sind eine Information über den Auswahlprozess,
nicht nur ein Loch in der Tabelle.
...
Die konkrete Faustregel dazu, sie steht nicht mehr auf der Folie: wenn 30
Prozent der Stichprobe wegfallen und das nicht zufällig geschieht, hast du
keine repräsentative Stichprobe mehr.
...
::: notes
**Faden.** Davor: die belasteten Schulen fallen aus der Testung. Hier: die
Systematik dahinter, und warum ausgerechnet unser Fall nicht reparabel ist.
Überleitung: "Fehlende Fälle sind das eine. Fehlende Studien sind das andere."
...
::: notes
**Faden.** Davor: innerhalb einer Studie fallen die schwierigen Fälle weg.
Hier: dieselbe Auswahllogik eine Ebene höher, jetzt fallen ganze Studien weg.
Überleitung: "Genug Diagnose. Was hilft eigentlich dagegen?"

Kernbotschaft: die Verzerrung entsteht bei der Auswahl dessen, was publiziert
...
::: notes
**Faden.** Davor: drei Verzerrungsquellen, vom Analysepfad bis zur
Publikationsauswahl. Hier: was dagegen hilft, getrennt in Diagnose und
Struktur. Überleitung: "Und jetzt seid ihr dran, allerdings von der anderen
Seite: ihr sollt gleich selbst p-hacken."
...
::: notes
**Faden.** Davor: Funnel-Plot, p-Curve und Präregistrierung als Gegenmittel.
Hier: der Auftrag, den Garten selbst auszubeuten. Danach: Pause, dann
Fragerunde zu Beginn von Einheit 3.
