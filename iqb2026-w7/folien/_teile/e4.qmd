...
::: notes
**Faden.** Davor: der Auftakt hat den Wechsel von der Diagnose zur
Alternative angekündigt. Hier: der Titel macht ihn zum Programm, ab jetzt
wird gebaut statt kritisiert. Überleitung: "Und ich fange mit einer Frage an,
bei der fast alle danebenliegen."
...
::: notes
**Faden.** Davor: der Titel kündigt die Umkehrung der Frage an. Hier: ein
Screening-Beispiel, bei dem die Intuition zuverlässig scheitert, mit
Handzeichen in drei Bändern. Überleitung: "Bevor ich auflöse, müssen wir
klären, worüber wir hier eigentlich reden, wenn wir Wahrscheinlichkeit
sagen."
...
Verfahrens. Das war der offene Faden von gestern.
:::

::: notes
**Faden.** Davor: das Screening, dessen Auflösung noch aussteht. Hier: zwei
Definitionen von Wahrscheinlichkeit, und der eingelöste Cliffhanger von
gestern. Überleitung: "Mit dieser zweiten Definition lässt sich rechnen, und
zwar mit genau einer Formel."
...
gestern ein: die Aussage, der wahre Wert liege mit 95 Prozent
Wahrscheinlichkeit im Intervall. Das ausdrücklich so benennen, nicht als
"Fehlannahme Nummer 7", daran erinnert sich niemand.
...
| **Likelihood** $P(D \mid \theta)$ | wie wahrscheinlich diese Daten wären, wenn die Hypothese stimmt |
...
::: notes
**Faden.** Davor: Wahrscheinlichkeit als Grad der Überzeugung. Hier: die
Formel, die genau damit rechnet, plus die vier Begriffe des Tages.
Überleitung: "Und jetzt löse ich das Screening von vorhin auf, ohne dass wir
irgendetwas rechnen müssen."
...
::: notes
**Faden.** Davor: das Bayes-Theorem als Formel. Hier: dieselbe Formel als
Bild, und damit die Auflösung des Screenings vom Anfang. Überleitung: "So
weit die Diagnostik. Jetzt dasselbe an unserer eigenen Studie."
...
::: {.bp-quelle}
Links steht ein t-Test für zwei Gruppen, rechts derselbe Vergleich
bayesianisch gerechnet. Das ist der **bayesianische t-Test**, und ihr rechnet
ihn heute den ganzen Tag.
:::

::: notes
**Faden.** Davor: die Basisrate am Screening, ein Lehrbuchfall. Hier:
dasselbe Vorgehen an unserer eigenen LeseStark-Studie, frequentistisch und
bayesianisch nebeneinander. Überleitung: "Und genau das seht ihr gleich
live."
...
Die Quellenzeile unten ausdrücklich vorlesen, sie ordnet den ganzen Tag ein.
Bis hierhin haben wir nie gesagt, welches Verfahren das eigentlich ist. Es ist
der Zweistichprobenvergleich, also genau der t-Test, den alle im Raum kennen,
nur bayesianisch gerechnet. Alle Anwendungen von heute rechnen ihn.

Wer weiterfragt, bekommt die Verallgemeinerung: ANOVA und Regression
funktionieren genauso. Jeder Parameter bekommt statt eines p-Werts eine
Posterior. Mehr dazu auf der Werkzeugfolie in Einheit 6.
...
::: notes
**Faden.** Davor: p-Wert und Posterior nebeneinander an festen Zahlen. Hier:
dieselbe Gegenüberstellung als Live-Demo mit beweglichen Reglern.
Überleitung: "Und jetzt seid ihr dran, allerdings zurück am Screening."
...
::: notes
**Faden.** Davor: die Live-Demo an p-Wert und Posterior. Hier: der Auftrag an
der Screening-Anwendung, also zurück zum Einstieg dieser Einheit. Danach:
Pause, dann Fragerunde zu Beginn von Einheit 5.
...
Auf dem Arbeitsblatt steht die Auffrischung zur bedingten Wahrscheinlichkeit
direkt bei den Aufgaben, aufklappbar, dazu der Posterior bei Aufgabe 3. Das
ansagen, es nimmt Druck von denen, die gestern nicht dabei waren.
